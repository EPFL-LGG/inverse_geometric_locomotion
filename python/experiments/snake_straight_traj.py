"""This script can be executed to let a snake follow a straight trajectory.
...
path_to_output_snake = os.path.join(path_to_output, "snake_straight_traj/")
...
from scipy.optimize import minimize, Bounds
from snake_straight_traj_settings import return_snake_straight_traj_experiment_settings
...
def main(_):
    ...
    settings_dict = return_snake_straight_traj_experiment_settings(trial_number)
    ...
    save_path = os.path.join(path_to_output_snake, "snake_straight_traj_init{}.json".format(tag_experiment))
    ...
    save_path_opt = os.path.join(path_to_output_snake, "snake_straight_traj_opt{}.json".format(tag_experiment))
