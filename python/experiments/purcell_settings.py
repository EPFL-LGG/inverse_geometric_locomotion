...
def return_purcell_experiment_settings(trial_number):
    '''
    Args:
    ...
    setting_dict['n_cp'] = 30
    setting_dict['n_ts'] = 200
    setting_dict['rho'] = 1.0
    setting_dict['eps'] = 0.5
    setting_dict['close_gait'] = True
    setting_dict['n_pts_per_segment'] = 50
    setting_dict['n_points_purcell'] = 4 + 3 * setting_dict['n_pts_per_segment']
